...
const Button = (_a) => {
    ...
    return (React__default["default"].createElement("button", Object.assign({ type: type, onClick: onClick, disabled: disabled, className: classnames("rg-btn", RecordColors$2[theme], RecordHeightSizes$2[height], RecordWidthSizes$2[width], RecordRounded$2[round], classNames) }, rest),
        iconLeft && React__default["default"].createElement("img", { className: "w-3", src: iconLeft, alt: alt }),
        React__default["default"].createElement("span", { className: `"bg-${theme}"` }, text),
        iconRight && React__default["default"].createElement("img", { className: "w-3", src: iconRight, alt: alt })));
};
...
const ButtonLink$1 = (_a) => {
    ...
    return (React__default["default"].createElement("a", Object.assign({ href: link, className: classnames("rg-btn", RecordColors$1[theme], RecordHeightSizes$1[height], RecordWidthSizes$1[width], RecordRounded$1[round], classNames) }, rest),
        iconLeft && React__default["default"].createElement("img", { className: "w-3", src: iconLeft, alt: alt }),
        React__default["default"].createElement("span", { className: `"bg-${theme}"` }, text),
        iconRight && React__default["default"].createElement("img", { className: "w-3", src: iconRight, alt: alt })));
};
...
const ButtonLink = ({ onClick, theme = "darkPrimary", height = "medium", width = "medium", round = "sm", alt = "", iconSrc = "https://rgonfire.com/assets/icons/svgs/star.svg", classNames, }) => {
    return (React__default["default"].createElement("img", { src: iconSrc, alt: alt, onClick: onClick, className: classnames("rg-btn", RecordColors[theme], RecordHeightSizes[height], RecordWidthSizes[width], RecordRounded[round], classNames) }));
};

exports.Button = Button;
exports.ButtonIcon = ButtonLink;
